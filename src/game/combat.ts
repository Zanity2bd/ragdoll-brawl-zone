...
export const MOVES: Record<SkinId, MoveSpec> = {
  superman: {
    ...
    windup: 0.55, active: 0.18, recover: 0.4, cooldown: 2.4,
  ...
  homelander: {
    ...
    windup: 0.3, active: 0.55, recover: 0.25, cooldown: 5.4,
  ...
  hulk: {
    ...
    windup: 0.5, active: 0.18, recover: 0.5, cooldown: 2.4,
  ...
  atrain: {
    ...
    windup: 0.12, active: 0.5, recover: 0.25, cooldown: 2.0,
  ...
  flash: {
    ...
    windup: 0.12, active: 0.05, recover: 0.45, cooldown: 2.4,
  ...
  spiderman: {
    ...
    windup: 0.22, active: 0.25, recover: 0.3, cooldown: 1.6,
  ...
  ironman: {
    ...
    windup: 0.2, active: 0.18, recover: 0.28, cooldown: 1.3,
  ...
  batman: {
    ...
    windup: 0.18, active: 0.25, recover: 0.32, cooldown: 1.6,
  ...
  butcher: {
    ...
    windup: 0.38, active: 0.18, recover: 0.45, cooldown: 2.0,
